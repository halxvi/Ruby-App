class MyTasksController < ApplicationController
  ...
  # GET /my_tasks.json
  def index
    @my_tasks = MyTask.paginate(page: params[:page],per_page: 8).order(sort_column + ' ' + sort_direction)
  end
  ...
  private
    ...
    def my_task_params
      params.require(:my_task).permit(:username, :task, :start_date, :end_date, :accomplished_flag)
    end
end
